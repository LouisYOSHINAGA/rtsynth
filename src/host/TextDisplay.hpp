...
// mode, a fake in the self-test...). LcdParameterDisplay draws through
// this, so swapping the physical display means implementing these four
// methods. Called only from the UI thread.
class TextDisplay {
public:
